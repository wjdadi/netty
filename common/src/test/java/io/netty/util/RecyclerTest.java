...
public class RecyclerTest {
    ...
    private static void testMaxCapacity(int maxCapacity) {
        ...
        assertTrue("The threadLocalCapacity must be <= maxCapacity as we not pool all new handles internally",
    ...
    public void testDiscardingExceedingElementsWithRecycleAtDifferentThread() throws Exception {
        ...
        assertTrue("The instances count must be <= array.length - maxCapacity / 2 as we not pool all new handles" +
